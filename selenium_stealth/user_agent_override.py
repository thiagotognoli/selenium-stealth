...
def user_agent_override(
    ...
    r = driver.execute_script(evaluationString(Path(__file__).parent.joinpath("js/platform.js").read_text(), { "userAgent": user_agent, "language": language, "platform": platform, "maskLinux": False }))
